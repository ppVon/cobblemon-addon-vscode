...
exports.buildPokemonSpeciesTemplate = buildPokemonSpeciesTemplate;
exports.buildPokemonResolverTemplate = buildPokemonResolverTemplate;
exports.buildPokemonPoserTemplate = buildPokemonPoserTemplate;
function buildPokemonSpeciesTemplate(args) {
    const moving = {
        walk: {
            canWalk: true,
            walkSpeed: 0.25,
...
function buildPokemonResolverTemplate(args) {
    const variations = [
        {
            aspects: [],
...
function buildPokemonPoserTemplate(args) {
    const poses = {
        standing: {
